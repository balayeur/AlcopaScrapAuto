...
* как делать прямую ссылку на аукцион Multisite, так как когда нет текущего empreinte carte bancaire, редирект на продажу не проходит, а выводится сообщение сообщающее, что нужно активировать empreinte
...
* сделать проверку что получается залогиниться, а то иногда бывает форма слетает
